...
export const managerrecommend_tmp_add = data => fetch('//yixsu.com/public/index.php/ADMINAPIManagerrecommend/managerrecommend/tmp_add', data, 'POST');
export const managerrecommend_cache_data = data => fetch('//yixsu.com/public/index.php/ADMINAPI/managerrecommend/cache_data', data, 'POST');
